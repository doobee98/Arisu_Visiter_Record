# Arisu_Visiter_Record
	...
	![Alt Text](https://github.com/doobee98/Arisu_Visiter_Record/blob/master/README_imgs/test.gif)
...
# 2020-01-11 : Build 1.1.1
	1. 이어쓰기 버튼 클릭시 간헐적으로 작동하지 않던 문제를 해결했습니다.





# 2019-12-17 : Build 1.1.0
	1. 검색 화면이 개선되었습니다. 이제 포함/일치를 선택하여 검색할 수 있으며, 
	   시간과 날짜 데이터의 경우 범위를 설정하여 검색할 수 있습니다.

	2. 화면에서 옵션 버튼을 삭제하였습니다. 앞으로 옵션 창은 상단 메뉴바에서만 접근 할 수 있습니다.
	
	3. ConvertExcel 프로그램을 통해 기록부-엑셀, 데이터베이스-엑셀 간 자유롭게 전환할 수 있습니다.
	
	4. 앞으로 기록부 뷰에서 인수인계 기록은 수정할 수 없습니다.
	
	5. 사용자 필드를 추가하거나 삭제할 수 있습니다.
